...
On every push to `main`, the CI pipeline runs static analysis via SonarQube, executes unit tests, builds and pushes a Docker image to Artifact Registry tagged with the commit SHA, then runs integration and E2E tests against that image.
